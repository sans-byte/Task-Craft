    ...
    <>
      <main className="w-full">
        <section className="sm:h-[28rem] w-full overflow-clip bg-bottom relative z-0">
          <Image src={banner} alt="sky" className="min-w-full" />
          <div className="sm:bg-slate-600/10 sm:backdrop-blur-sm sm:w-3/6 absolute text-6xl top-2/4 font-family-bebas sm:left-[6%]">
